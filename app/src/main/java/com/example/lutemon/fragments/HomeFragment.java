...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_transfer_home, container, false);
    }
    @Override
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        healLutemons(); // Heal Lutemons that are located at home.
    ...
    public void createLutemonSelection(View view) {
        ...
        LinearLayout llLutemonsAtHome = view.findViewById(R.id.llLutemonsLocation);
        for (Lutemon lutemon : storage.getLutemons()) {
            if ("Home".equals(lutemon.getLocation())) {
                ...
                llLutemonsAtHome.addView(cbLutemonAtHome);
            }
        }
    }
    ...
    public void transfer(View view) {
        ...
        for (int i=0; i < llLutemonsAtHome.getChildCount(); i++) {
            CheckBox cbLutemon = (CheckBox) llLutemonsAtHome.getChildAt(i);
    ...
    public void healLutemons() {
        for (Lutemon lutemon : storage.getLutemons()) {
            if ("Home".equals(lutemon.getLocation())) {
                lutemon.setHealth(lutemon.getMaxHealth()); // Lutemon is healed when located at home.
            }
        }
