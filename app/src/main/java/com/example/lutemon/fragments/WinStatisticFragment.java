...
public class WinStatisticFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_winstatistics, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        for (Lutemon lutemon : Storage.getInstance().getLutemons()) {
            BarEntry entry = new BarEntry(index,(float) lutemon.getWinCount());
        ...
        BarDataSet barDataSet = new BarDataSet(dataValues, "Wins");
        ...
        barChart.getDescription().setText("Wins");
