...
public class LoseStatisticFragment extends Fragment {
    private ArrayList<BarEntry> dataValues = new ArrayList<>();

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_losestatistics, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        for (Lutemon lutemon : Storage.getInstance().getLutemons()) {
            BarEntry entry = new BarEntry(index,(float) lutemon.getLoseCount());
        ...
        barChart.getDescription().setText("Loses");
